...
public class Hospital {
     ...
     * MedicineSchedule getScheduleMethodResult = (MedicineSchedule)
     * getScheduleMethod.invoke(unloaded);
     * Method getMedicineNameMethod =
     * unloaded.getClass().getMethod("getMedicineName");
     * String getMedicineNameMethodResult = (String)
     * getMedicineNameMethod.invoke(unloaded);
     * System.out.println(String.format("Checking whether Hospital can receive %s.",
     * getMedicineNameMethodResult));
     * if (getScheduleMethodResult != MedicineSchedule.Uncontrolled) {
     * System.out.println(String.
     * format("Hospital cannot receive controlled substances and %s is a %s.",
